...
pdfjs-one-page-rotate-cw-button =
    .title = Rotar pagina en sentido horario
pdfjs-one-page-rotate-cw-button-label = Rotar pagina en sentido horario
pdfjs-one-page-rotate-ccw-button =
.title = Rotar pagina en sentido antihorario
pdfjs-one-page-rotate-ccw-button-label = Rotar pagina en sentido antihorario

...
pdfjs-one-page-rotate-cw-button =
    .title = Rotation page horaire
pdfjs-one-page-rotate-cw-button-label = Rotation page horaire
pdfjs-one-page-rotate-ccw-button =
    .title = Rotation page antihoraire
pdfjs-one-page-rotate-ccw-button-label = Rotation page antihoraire
...
pdfjs-certificate-loading = En cours de chargement...
## Show all highlights
